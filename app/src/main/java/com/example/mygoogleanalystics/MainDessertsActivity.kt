...
class MainDessertsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_main_desserts)

        mFirebaseAnalytics = FirebaseAnalytics.getInstance(this);

        track("Desserts Details screen")
    }
    ...
    override fun onPause() {
        ...
        user["second"] = s
        user["id"] = uuid
        user["name"] = "Desserts Details screen"
