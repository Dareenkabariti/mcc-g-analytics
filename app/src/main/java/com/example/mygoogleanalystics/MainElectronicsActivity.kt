...
import kotlinx.android.synthetic.main.activity_main_electronics.*
import kotlinx.android.synthetic.main.activity_main_food.*
import java.util.*

class MainElectronicsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_main_electronics)
        mFirebaseAnalytics = FirebaseAnalytics.getInstance(this);

        track("Electronic Products screen")
        laptop.setOnClickListener {
            btnEvent("laptop@123","laptop","button")

            var intent = Intent(this,MainLptopsActivity::class.java)
            startActivity(intent)
        }

        phone.setOnClickListener {
            btnEvent("phone@123","phone","button")

            var intent = Intent(this,MainIphoneActivity::class.java)
            startActivity(intent)
        }
        TV.setOnClickListener {
            btnEvent("TV@123","TV","button")

            var intent = Intent(this,MainSmartTvActivity::class.java)
            startActivity(intent)
        }
    }
    ...
    override fun onPause() {
        ...
        user["second"] = s
        user["id"] = uuid
        user["name"] = "Electronic Products screen"
